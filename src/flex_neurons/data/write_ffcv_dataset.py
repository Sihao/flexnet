...
from .dataset_imagenet import ImageNet100Dataset
...
def main():
    ...
    config_path = Path("configs/configurations.yml")
    if not config_path.exists():
        raise FileNotFoundError(
            "configs/configurations.yml not found. Please run from project root."
        )
